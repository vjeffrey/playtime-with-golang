...
var LocationMap = map[string]*Location{
	"Bench":  {Description: "Close your eyes and imagine you are sitting on a bench by the canal in Amsterdam, on a warm night, breathing in the fresh air, listening to the early morning animals awaken.", Transitions: []string{"Room", "Lift", "Mall"}},
	...
	"Lift":   {Description: "A Sailor Moon style awesome wind tunnel that takes you anywhere in the world.", Transitions: []string{"Bench", "Lounge", "Forest", "Mall"}, Events: []string{"firefly"}},
